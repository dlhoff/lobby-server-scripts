...
public class GameRequestTable {
    ...
    public static void init() {
        ...
        add(NetworkCode.MC_MATCH_INIT, "convergegame.RequestMCMatchInit");   
        add(NetworkCode.MC_GET_TIME, "convergegame.RequestConvergeGetTime");
        add(NetworkCode.MC_BET_UPDATE, "convergegame.RequestConvergeBetUpdate");
        add(NetworkCode.MC_GET_NAMES, "convergegame.RequestConvergeGetNames");
